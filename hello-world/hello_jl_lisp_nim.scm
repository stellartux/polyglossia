...
(defun msg () "Hello from Common Lisp, Julia, Nim and Scheme!")
...
const msg = "Hello from Common Lisp, Julia, Nim and Scheme!"
...
(define (msg) "Hello from Common Lisp, Julia, Nim and Scheme!")

; code visible to Common Lisp, Julia, Nim and Scheme |#;]## =#
